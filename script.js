...
// var questions2 = [
//     ["Quel célèbre dictateu des années 1920 à 1953 ?", "Staline", "Lénine", "Trotski", "A"], // index 0 question
//     ["Dans quel pays peut-on trouver la Catalogne, l’Andalousie et la Castille ?", "La France", "L'Espagne", "La Hongrie", "B"],//index 1, 2 et 3 = choix
//     ["Qui a dit “ Le sort en est jeté” 'Alea jacta est'? ", "Napoléon", "Hitler", "Jules César", "C"],// index 4 solution
//     ["Quel cinéaste a réalisé “Parle avec elle” et “Volver” ? ", "Pablo Trapero", "Pedro Almodovar", "Woody Allen", "B"],
//     ["Quel pays a remporté la coupe du monde de football en 2014 ? ", "L'Allemagne", "La France", "Le Brésil", "A"],
...
function renderQuestion() { //rendu des reponses correctes avec fin du quiz
    quest = game("quiz");
    if (index >= questions.length && correct >= 13) {
    ...
    quest.innerHTML += "<input type='radio' name='choices' onclick='btnView()' value='A' id=\'choice\'><label id='lb1' for=\"choice\"> " + chA + "</label><br>";
    quest.innerHTML += "<input type='radio' name='choices' onclick='btnView()' value='B' id=\'choice2\'><label id='lb2' for=\"choice2\"> " + chB + "</label><br>";
    quest.innerHTML += "<input type='radio' name='choices' onclick='btnView()' value='C' id=\'choice3\'><label id='lb3' for=\"choice3\"> " + chC + "</label><br>";
    quest.innerHTML += "<button  id=\'btn\' onclick='checkAnswer()'  > Question suivante ! </button>";
    btnView();
}
...
function btnView() {
    ...
    var checkBox3 = document.getElementById("choice3");
